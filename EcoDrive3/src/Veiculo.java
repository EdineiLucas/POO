...
public class Veiculo {
    private ArrayList<Viagem> historico_viagens;
    ...
    public Veiculo (String modelo, String placa, double odometro, int niveldecombustivel){
        ...
        this.historico_viagens = new ArrayList<>();
    }
    ...
    public void Registrar_viagem(int Distancia_KM){
        ...
        if (combustivel_necessario > getNivelCombustivel()){
            ...
            this.historico_viagens.add(adicionar_viagem(Distancia_KM));
            System.out.println("Viagem Registrada com sucesso");
        }
    }

    public Viagem adicionar_viagem(int distancia){
        Viagem v = new Viagem(distancia, LocalDate.now());
        return v;
    }

    public void relatorio(){
        int distancia_total = 0;
        for (Viagem v : this.historico_viagens){
            distancia_total = distancia_total + v.getDistancia_da_viagem();
            System.out.println("Data da viagem:" + v.getData() + "/ Distancia:" + v.getDistancia_da_viagem());
        }
        System.out.println("Distancia de todas as viagens: " + distancia_total);
        return;
    }
    ...
    public boolean equals(Object obj){
        System.out.println("DEBUG: Java chamou o equals para comparar as matrículas");
        ...
        return java.util.Objects.equals(this.Placa, other.Placa);
    }

    @Override
    public int hashCode(){
        return Objects.hash(this.Placa);
    }
    ...
    public String getCondutor() {
        if (this.Condutor == null){
            return "Sem condutor atribuido";
        }
        return this.Condutor.getNome();
    }
